...
<div className="navbar-default sidebar sidenav" style={{ marginLeft: '-20px' }} role="navigation">
        <div className="sidebar-nav navbar-collapse collapse">
          <ul className="nav in" id="side-menu">
            ...
            <li>
              <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/'); }} >
            ...
            <li className={classNames({ active: !this.state.chartsElementsCollapsed })}>
              ...
              >
                <li>
                  <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/flotcharts'); }} >
                    FlotCharts
                  </a>
                </li>
                <li>
                  <a
                    href=""
                    onClick={(e) => { e.preventDefault(); window.history.push('/morrisjscharts'); }}
                  >
                    Morrisjs Charts
                  </a>
                </li>
            ...
            <li>
              <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/table'); }} >
                <i className="fa fa-table fa-fw" /> &nbsp;Tables
              </a>
            </li>

            <li>
              <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/forms'); }} >
            ...
            <li className={classNames({ active: !this.state.uiElementsCollapsed })}>
              ...
              >
                <li>
                  <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/panelwells'); }} >
                    Panels And Wells
                  </a>
                </li>
                <li>
                  <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/button'); }} >
                    Buttons
                  </a>
                </li>
                <li>
                  <a
                    href=""
                    onClick={(e) => { e.preventDefault(); window.history.push('/notification'); }}
                  >
                    Notification
                  </a>
                </li>
                <li>
                  <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/typography'); }} >
                    Typography
                  </a>
                </li>
                <li>
                  <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/icons'); }} >
                    Icons
                  </a>
                </li>
                <li>
                  <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/grid'); }} >
                    Grid
                  </a>
                </li>
              </ul>
            ...
            <li className={classNames({ active: !this.state.samplePagesCollapsed })}>
              ...
              >
                <li>
                  <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/blank'); }} >
                    Blank
                  </a>
                </li>
                <li>
                  <a href="" onClick={(e) => { e.preventDefault(); window.history.push('/login'); }} >
                    Login
                  </a>
                </li>
              </ul>

...
class SelectCharts extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      allProjects: ['Release Burndown Chart', 'Team Velocity Chart', 'Plan Vs Actual Chart', 'Fix Version Chart', 'Component Chart', 'Epic Completetion Chart', 'Current Sprint Report', 'Module Sub-Module Report'],
      showModal: false,
      search: '',

	...
	renderChart = () => {
		switch(this.props.name) {
			...
			case 'Fix Version Chart':
				return <FixVersionChart name={this.props.name} removeChart={this.props.removeChart} viewToggled={this.props.viewToggled} projectsChanged={this.props.projectsChanged} />;	
